...
Проект **ChartWork** выполнен в качестве учебной работы по итогам изучения основ языка Java на курсе Нетологии. 

**ChartWork** является клиент-серверным многопоточным приложением, воплощающим требования, изложенные в [ТЗ](./TT.md).

Программный комплекс состоит из двух приложений: Чат-Сервер и Чат-Клиент.

Функционал заключается в общении нескольких пользователей **Клиента** посредством текстовых сообщений в консоли,
